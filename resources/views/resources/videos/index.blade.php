								...
								<aside class="sidebar static left">
									<div class="widget stick-widget ">
										...
										<form class="video-search" method="post">
											<i class=""><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></i>
								...
								<div class="main-wraper">
									...
									<div class="main-wraper">
										<div class="user-post video">
											<div class="friend-info">
												<figure>
													<img alt="" src="{{asset('images/resources/user1.jpg')}}">
												</figure>
									...
									<div class="main-wraper">
										<div class="user-post video">
											<div class="friend-info">
												<figure>
													<img alt="" src="{{asset('images/resources/user2.jpg')}}">
												</figure>
												<div class="friend-name">
													<div class="more">
														<div class="more-post-optns">
									...
									<div class="main-wraper">
										<div class="user-post video">
											<div class="friend-info">
												<figure>
													<img alt="" src="{{asset('images/resources/user3.jpg')}}">
												</figure>
												<div class="friend-name">
													<div class="more">
														<div class="more-post-optns">
